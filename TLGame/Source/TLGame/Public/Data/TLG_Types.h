...
//------------------------------------------------------------------------------------------------------------
UENUM(BlueprintType) enum class EDialogue_Response_Category : uint8  // !!! TEMP Used only for color, need refactoring
{
...
USTRUCT(BlueprintType) struct FTLG_Location_Action
{
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite) FGameplayTagContainer Gameplay_Tag_Container;
...
public:
    UPROPERTY(EditAnywhere, BlueprintReadWrite) TArray<FTLG_Action_Requirement> Requirement_Response;
    UPROPERTY(EditAnywhere, BlueprintReadWrite) TArray<FTLG_Set_By_Caller_Magnitude> Set_By_Caller_Magnitude;
