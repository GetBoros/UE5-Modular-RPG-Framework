...
public:
    ...
    UFUNCTION(BlueprintCallable) void Init(const FPlayer_Response &data, int32 index);  // Инициализация кнопки данными
    ...
    UPROPERTY(meta = (BindWidget)) TObjectPtr<UButton> Btn_Click;
