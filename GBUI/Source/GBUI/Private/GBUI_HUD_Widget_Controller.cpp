...
void UGBUI_HUD_Widget_Controller::Broadcast_Initial_Values()
{
    ...
    if (gbg_attribute_set == 0)
        return;

    On_Health_Changed.Broadcast(gbg_attribute_set->Get_Health() );
    On_Health_Max_Changed.Broadcast(gbg_attribute_set->Get_Health_Max() );
    On_Stamina_Changed.Broadcast(gbg_attribute_set->Get_Stamina() );
    On_Stamina_Max_Changed.Broadcast(gbg_attribute_set->Get_Stamina_Max() );
}
//------------------------------------------------------------------------------------------------------------
void UGBUI_HUD_Widget_Controller::Bind_Callbacks_To_Dependencies()
{
    ...
    Ability_System_Component->GetGameplayAttributeValueChangeDelegate(gbg_attribute_set->GetMaxHealthAttribute() ).AddUObject(this, &UGBUI_HUD_Widget_Controller::Health_Max_Changed);
    ...
    Ability_System_Component->GetGameplayAttributeValueChangeDelegate(gbg_attribute_set->GetMaxStaminaAttribute() ).AddUObject(this, &UGBUI_HUD_Widget_Controller::Stamina_Max_Changed);
}
//------------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------------
void UGBUI_HUD_Widget_Controller::Health_Max_Changed(const FOnAttributeChangeData &data)
{
    On_Health_Max_Changed.Broadcast(data.NewValue);
}
//------------------------------------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------------------------------------
void UGBUI_HUD_Widget_Controller::Stamina_Max_Changed(const FOnAttributeChangeData &data)
{
    On_Stamina_Max_Changed.Broadcast(data.NewValue);
}
//------------------------------------------------------------------------------------------------------------
